  ...
  <div class="navbar-collapse collapse navbar-right" id="navbarNav">
    <ul class="nav navbar-nav ml-auto">
      <li class="nav-item border-right border-light" style="padding-top: 8px; padding-left: 5px; padding-right: 5px">
        <a href="https://dutacitra-automaticdoor.com/lineardoors-id/"><img class="img-responsive" src="@asset('images/ID32.png')"></a>
      </li>
      <li class="nav-item" style="padding-top: 8px; padding-left: 5px; padding-right: 5px">
        <a href="https://dutacitra-automaticdoor.com/lineardoors-en/"><img class="img-responsive" src="@asset('images/US32.png')"></a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="https://dutacitra-automaticdoor.com/app/uploads/2018/08/lineardoors.pdf">Linear door</a>
        </div>
      </li>
      <li class="nav-item">
  ...
  <div class="container">
    ...
    <div class="row featurette">
      <div class="col-md-4 order-md-2" style="padding-left: 30px">
        ...
        <a class="btn btn-outline-secondary btn-sm" href="https://dutacitra-automaticdoor.com/app/uploads/2018/08/lineardoors.pdf">View Linear doors PDF</a>
      </div>
