{{--
  Template Name: expressgate-en Template
--}}
    ...
    <div class="row featurette">
      <div class="col-md-4 order-md-2" style="padding-left: 30px">
        ...
        <p class="text-muted" style="line-height:20px; text-align:justify">
          <font size="2">Express Gate consists of an elegant module that supports the sliding glass panels, the security photocells, the access control reader and Manusa´s exclusive system for secured panel opening.</font>
        </p>
          &nbsp;
        <h5>
          <p>Main features</p>
        ...
        <p class="text-muted" style="margin-bottom:8px; line-height:15px">
          <font size="2">Access corridor controlled by hidden panels.</font>
        </p>
        <hr style="margin-top: 0%; margin-bottom: 0%">
        <p class="text-muted" style="margin-top: 8px; margin-bottom: 6px; line-height:15px">
          <font size="2">Suitable for the access surveillance of people entering into offices, sport facilities, leisure areas, etc.</font>
        </p>
        <hr style="margin-top: 0%; margin-bottom: 0%">
        <p class="text-muted" style="margin-top: 8px; margin-bottom: 8px; line-height:15px">
          <font size="2">An elegant module supports the glass panels as well as the control photocells.</font>
        </p>
        <hr style="margin-top: 0%; margin-bottom: 0%">
        <p class="text-muted" style="margin-top: 8px; margin-bottom: 8px; line-height:15px">
          <font size="2">Maximum anti-blocking security for persons.</font>
        </p>
        <hr style="margin-top: 0%; margin-bottom: 0%">
        <p class="text-muted" style="margin-top: 8px; margin-bottom: 6px; line-height:15px">
          <font size="2">Maximum antifraud control by movement supervision.</font>
        </p>
        <hr style="margin-top: 0%; margin-bottom: 0%">
        <p class="text-muted" style="margin-top: 8px; margin-bottom: 8px; line-height:15px">
          <font size="2">Adaptable to other security systems or access controls already installed.</font>
        </p>
        <hr style="margin-top: 0%; margin-bottom: 0%">
        <p class="text-muted" style="margin-top: 8px; margin-bottom: 8px; line-height:15px">
          <font size="2">Adaptable to any architectonic project.</font>
        </p>
        <hr style="margin-top: 0%; margin-bottom: 0%">
        <p class="text-muted" style="margin-top: 8px; margin-bottom: 8px; line-height:15px">
          <font size="2">Personalized in finishing materials of the top lid and colors.</font>
        </p>
        <hr style="margin-top: 0%; margin-bottom: 0%">
        <p class="text-muted" style="margin-top: 8px; margin-bottom: 8px; line-height:15px">
