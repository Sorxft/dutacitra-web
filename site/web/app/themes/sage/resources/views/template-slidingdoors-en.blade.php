{{--
  Template Name: slidingdoors-en Template
--}}
  ...
  <div class="container-fluid" style="position: relative;">
    <div class="row" style="padding: 0%">
      ...
      <div class="text-center" style="position: absolute; top: 60%; left: 7%; font-family:Arial, Helvetica, sans-serif">
        <font color="#ffffff"><h2>SLIDING DOORS</h2></font>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="row featurette">
      <div class="col-md-4 order-md-2" style="padding-left: 30px">
        ...
        <p class="text-muted" style="line-height:20px">
          <font size="2">The standard sliding door with bi-part or single slide opening is the most popular automatic and functional door. Recommended for public entrances and exits high traffic flow of people, or where the safety of the users is linked to the flow of traffic.</font>
        </p>
          &nbsp;
        <h5>
          <p>Main features</p>
        ...
        <p class="text-muted" style="margin-bottom:8px; line-height:15px">
          <font size="2">The most popular and functional automatic door.</font>
        </p>
        <hr style="margin-top: 0%; margin-bottom: 0%">
        <p class="text-muted" style="margin-top: 8px; margin-bottom: 6px; line-height:15px">
          <font size="2">Recommended for entrances and exits with high traffic flow of people.</font>
        </p>
        <hr style="margin-top: 0%; margin-bottom: 0%">
        <p class="text-muted" style="margin-top: 8px; margin-bottom: 8px; line-height:15px">
          <font size="2">Offer the maximum opening speed in the market.</font>
        </p>
        <hr style="margin-top: 0%; margin-bottom: 0%">
        <p class="text-muted" style="margin-top: 8px; margin-bottom: 8px; line-height:15px">
        ...
        <a class="btn btn-outline-secondary btn-sm" href="http://dutacitra.test/app/uploads/2018/07/visio.pdf">View Visio PDF</a>
        <a class="btn btn-outline-secondary btn-sm" href="http://dutacitra.test/app/uploads/2018/07/activaplus.pdf">View Activa PDF</a>
      </div>
