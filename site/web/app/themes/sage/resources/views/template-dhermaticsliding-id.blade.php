{{--
  Template Name: DEEMhermaticsliding-id Template
--}}
  ...
  <div class="container-fluid" style="position: relative;">
    <div class="row" style="padding: 0%">
      ...
      <div class="text-center" style="position: absolute; top: 60%; left: 7%; font-family:Arial, Helvetica, sans-serif">
        <font color="#ffffff"><h2>DEEM HERMATIC SLIDING DOORS</h2></font>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="row featurette">
      <div class="col-md-4 order-md-2">
        <h3 class="featurette-heading">
          <p>DEEM hermatic sliding doors</p>
        </h3>
        <p class="text-muted">
        ...
        <a class="btn btn-outline-secondary btn-sm" href="#">View DEEM Hermatic PDF</a>
      </div>
