{{--
  Template Name: hermetic-swingdoors-en Template
--}}
  ...
  <div class="navbar-collapse collapse navbar-right" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item border-right border-light" style="padding-top: 8px; padding-left: 5px; padding-right: 5px">
        <a href="https://dutacitra-automaticdoor.com/hermetic-swingdoors-id/"><img class="img-responsive" src="@asset('images/ID32.png')"></a>
      </li>
      <li class="nav-item" style="padding-top: 8px; padding-left: 5px; padding-right: 5px">
        <a href="https://dutacitra-automaticdoor.com/hermetic-swingdoors-en/"><img class="img-responsive" src="@asset('images/US32.png')"></a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="https://dutacitra-automaticdoor.com/app/uploads/2018/07/hermetic.pdf">Hermetic</a>
        </div>
      </li>
      <li class="nav-item">
    ...
    <div class="row featurette">
      <div class="col-md-4 order-md-2" style="padding-left: 30px">
        ...
        <p class="text-muted" style="line-height:20px">
          <font size="2">Unique mechanisms guarantee the air tightness of our swing doors. Adaptable to any project from a functional and aesthetic point of view.</font>
        </p>
          &nbsp;
        <h5>
          <p>Main features</p>
        ...
        <p class="text-muted" style="margin-bottom:8px; line-height:15px">
          <font size="2">The totality of the hermetic swing doors is designed to guarantee and ensure hermetic tightness.</font>
        </p>
        ...
        <hr style="margin-top: 0%; margin-bottom: 0%">
        <p class="text-muted" style="margin-top: 8px; margin-bottom: 6px; line-height:15px">
          <font size="2">One or double leaf.</font>
        </p>
        <hr style="margin-top: 0%; margin-bottom: 0%">
        <p class="text-muted" style="margin-top: 8px; margin-bottom: 8px; line-height:15px">
          <font size="2">The totality of the door is designed to guarantee hygiene.</font>
        </p>
        <hr style="margin-top: 0%; margin-bottom: 0%">
        <p class="text-muted" style="margin-top: 8px; margin-bottom: 8px; line-height:15px">
