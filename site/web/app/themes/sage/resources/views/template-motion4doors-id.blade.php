{{--
  Template Name: motion4doors-id Template
--}}
  ...
  <div class="container-fluid" style="position: relative;">
    <div class="row" style="padding: 0%">
      ...
      <div class="text-center" style="position: absolute; top: 60%; left: 7%; font-family:Arial, Helvetica, sans-serif">
        <font color="#ffffff"><h2>MOTION 4 DOORS</h2></font>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="container">
    ...
    <div class="row featurette">
      <div class="col-md-4 order-md-2">
        ...
        <a class="btn btn-outline-secondary btn-sm" href="http://dutacitra.test/app/uploads/2018/07/motion4.pdf">View Motion 4 PDF</a>
      </div>
